...
void Wheel::sendSocketVelocity()
{
    message_socket_velocity[this->id] = "Wheel_ID:" + String(this->id) + " Target_RPM:" + String(this->getTargetRPM()) + " Current_RPM:" + String(this->currentRPM) + " PWM:" + String(this->pwm);
}
...
void Wheel::infoVelocity()
{
    ...
    Serial.print(this->getTargetRPM());
    // Serial.print("\tPulse:"); Serial.print(this->getEncValue());
    Serial.print("\tCurrent_RPM:");
    Serial.print(this->currentRPM * this->cur_direction);
    Serial.print("\tDirection:");
    Serial.print(this->cur_direction == RIGHT_DIR ? "RIGHT" : "LEFT");
    Serial.print("\tPWM:");
...
void Wheel::infoPosition()
{
    ...
    Serial.print(this->getTargetPosition());
    Serial.print("\tCurrent_position:");
    Serial.print(this->getEncPosition());
    Serial.print("\tTarget_Direction:");
    Serial.print(this->direction == RIGHT_DIR ? "RIGHT" : "LEFT");
